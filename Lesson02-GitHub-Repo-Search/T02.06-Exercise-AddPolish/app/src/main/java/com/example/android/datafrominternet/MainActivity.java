...
public class MainActivity extends AppCompatActivity {
    ...
    private ProgressBar mProgressIndicatorProgressBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgressIndicatorProgressBar = (ProgressBar) findViewById(R.id.pb_loading_indicator);
    }
    ...
    public class GithubQueryTask extends AsyncTask<URL, Void, String> {
        ...
        protected void onPreExecute() {
            mProgressIndicatorProgressBar.setVisibility(View.VISIBLE);
        }
        ...
        protected void onPostExecute(String githubSearchResults) {
            ...
            mProgressIndicatorProgressBar.setVisibility(View.INVISIBLE);
